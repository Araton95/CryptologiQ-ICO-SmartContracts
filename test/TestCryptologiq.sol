...
contract TestCryptologiq
{
    function testInitialBalanceUsingDeployedContract() public
    {
        CryptologiqContract stream = CryptologiqContract(DeployedAddresses.CryptologiqContract());
    ...
    function testInitialBalanceWithNewCryptologiq() public
    {
        ...
        Assert.equal(stream.balanceOf(tx.origin), expected, "Owner should have 0 Cryptologiq initially");
    }
    ...
    function testStartCrowdsalePreIco() public
    {
        ...
        stream.startCrowd(amountAfter, 1517400000, 5, 30, 0);
    ...
    {
        CryptologiqContract stream = new CryptologiqContract();
        uint256 tokensAfterPay = 4200000000000000000;
        ...
        Assert.equal(stream.balanceOf(0x1), tokensAfterPay, "Investor should have a 4200000000000000000 tokens");
    }
